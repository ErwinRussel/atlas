...
void service_listener() {
    ...
    while(1){
        ...
        switch (func_type)
        {
            ...
            case GLLOADTRANSPOSEMATRIXD: ;
                args_glLoadTransposeMatrixd argp_glloadtransposematrixd;

                // assert payload size
                if(ShmPTR->payload_size != sizeof(args_glLoadTransposeMatrixd)){
                    printf("Wrong payload size\n\n");
                    ShmPTR->status = LISTEN;
                    break;
                }
                ...
                // Memcopy from Buffer
                memcpy(&argp_glloadtransposematrixd, ShmPTR->buffer, sizeof(args_glLoadTransposeMatrixd));

                // Execute function call
                glloadtransposematrixd_lh(&argp_glloadtransposematrixd);

                // Print
                printf("RESPONSE: Data type: %d\n\n", ShmPTR->data_type);
                break;

            case GLLOADTRANSPOSEMATRIXF: ;
                args_glLoadTransposeMatrixf argp_glloadtransposematrixf;

                // assert payload size
                if(ShmPTR->payload_size != sizeof(args_glLoadTransposeMatrixf)){
                    printf("Wrong payload size\n\n");
                    ShmPTR->status = LISTEN;
                    break;
                }
                ...
                // Memcopy from Buffer
                memcpy(&argp_glloadtransposematrixf, ShmPTR->buffer, sizeof(args_glLoadTransposeMatrixf));

                // Execute function call
                glloadtransposematrixf_lh(&argp_glloadtransposematrixf);

                // Print
                printf("RESPONSE: Data type: %d\n\n", ShmPTR->data_type);
                break;

            case GLMULTTRANSPOSEMATRIXD: ;
                args_glMultTransposeMatrixd argp_glmulttransposematrixd;

                // assert payload size
                if(ShmPTR->payload_size != sizeof(args_glMultTransposeMatrixd)){
                    printf("Wrong payload size\n\n");
                    ShmPTR->status = LISTEN;
                    break;
                }
                ...
                // Memcopy from Buffer
                memcpy(&argp_glmulttransposematrixd, ShmPTR->buffer, sizeof(args_glMultTransposeMatrixd));

                // Execute function call
                glmulttransposematrixd_lh(&argp_glmulttransposematrixd);

                // Print
                printf("RESPONSE: Data type: %d\n\n", ShmPTR->data_type);
                break;

            case GLMULTTRANSPOSEMATRIXF: ;
                args_glMultTransposeMatrixf argp_glmulttransposematrixf;

                // assert payload size
                if(ShmPTR->payload_size != sizeof(args_glMultTransposeMatrixf)){
                    printf("Wrong payload size\n\n");
                    ShmPTR->status = LISTEN;
                    break;
                }
                ...
                // Memcopy from Buffer
                memcpy(&argp_glmulttransposematrixf, ShmPTR->buffer, sizeof(args_glMultTransposeMatrixf));

                // Execute function call
                glmulttransposematrixf_lh(&argp_glmulttransposematrixf);
